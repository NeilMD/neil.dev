  ...
  return (
    <main className=" min-h-svh w-full flex flex-col justify-center items-center bg-n-bg font-extralight mt-24">
      <div className="relative max-w-4xl  flex flex-col gap-8">
        ...
        <div className="flex flex-row text-justify gap-8">
          <div className="flex-1/3 text-md flex flex-col  gap-3 text-justify">
            {" "}
        ...
        <div id="proj-gallery" className="grid grid-cols-3 w-full gap-8">
          ...
          <AnimatedContent
            ...
            initialOpacity={0.2}
            animateOpacity
            className="col-start-1 col-span-1  px-4 py-8 rounded-2xl bg-stone-50 shadow-2xl text-center z-10"
            threshold={0.2}
          >
            <div>
          ...
          <AnimatedContent
            ...
            initialOpacity={0.2}
            animateOpacity
            className="col-start-2 col-span-2  px-4 py-8 rounded-2xl bg-stone-50 shadow-2xl text-center z-10"
            threshold={0.2}
          >
            <div>
